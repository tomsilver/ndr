...
def find_policy(planner_name, initial_state, goal, ndr_operators, action_space, observation_space):
    if planner_name == "ff_replan":
        return find_ff_replan_policy(initial_state, goal, ndr_operators, action_space, observation_space)
    raise Exception("Unknown planner `{}`".format(planner_name))

def find_ff_replan_policy(initial_state, goal, ndr_operators, action_space, observation_space):
